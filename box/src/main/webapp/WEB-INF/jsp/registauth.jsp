...
<body>
    ...
    <div class="registauth__center">
        <div class="common__double">
            <img src="${pageContext.request.contextPath}/images/qr_login.png"/>
        </div>
        <div class="common__double">
            <div id="frame"></div>
        		      ...
        		      var code = jsQR(imageData.data, imageData.width, imageData.height, {
                              ...
                              if(code) {
                                    ...
                                    if (splitedCodeDatas.length == 2) {
                                    	var id = splitedCodeDatas[0];
                                    	var pw = splitedCodeDatas[1];
  										
                                    	$.ajax({
                                    		url: "http://localhost:8080/box/registauth",
                                    		type: "post",
